...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url(assets/images/kartu.jpg);">
		<h2 class="tit6 t-center">
			Unit Usaha Bantuan Sosial
		</h2>
	</section>
	  ...
	  <section class="bg2-pattern p-t-116 p-b-110 t-center p-l-15 p-r-15">
	    ...
	    <h3 class="tit3 t-center m-b-35 m-t-5">
	      Bantuan Sosial BUMDes
	    </h3>

	    <p class="t-center size32 m-l-r-auto">
	      Unit Bantuan Sosial adalah unit yang menyalurkan bantuan di bidang sosial berupa bahan pokok sehari-hari yang bertujuan meningkatkan kesejahteraan penduduk Desa Kepunduhan. 
	    </p>
	  </section>
    <!-- Video -->
    <section class="section-video parallax100" style="background-image: url(assets/images/bansos9.jpg);">
      <div class="content-video t-center p-t-135 p-b-158">
    ...
    <section class="bg2-pattern p-t-50 p-b-110 t-center p-l-15 p-r-15">
      <!-- <span class="tit2 t-center">
        Unit Simpan Pinjam
      </span>
      ...
      <p class="t-center size32 m-l-r-auto">
        Simpan Pinjam adalah jenis usaha yang bergerak di bidang perhimpunan dan penyaluran dana kepada masyarakat melalui usaha simpan pinjam yang dikelola secara individu di bawah badan usaha milik desa yang di bentuk oleh pemerintah desa.
      </p> -->
    </section>
      ...
      <div class="row">
        <div class="col-md-6 p-t-45 p-b-30">
          <div class="section-intro mb-lg-4">
              <h4 class="intro-title tit2">
              Data Penerima
            </span>

            <h2>
              Bantuan Sosial Covid Kering
            </h2>

            <p class="t-justify m-b-22 size3 m-l-r-auto">
              Untuk melihat detail data penerima bantuan sosial covid kering silakan klik
            </p>
            <a class="button button-shadow mt-2 mt-lg-4" href="https://docs.google.com/spreadsheets/d/1WQCy42bO57UXTgWfcmeKvf1-iAO6zQpfyxSW8W1tRg8/edit?usp=sharing">Disini</a>
          </div>
        </div>

        <div class="col-md-6 p-t-45 p-b-30">
          <div class="wrap-pic-welcome size2 bo-rad-10 hov-img-zoom m-l-r-auto">
            <img src="<?php echo base_url() ?>assets/images/data5.png" alt="IMG-OUR">
          </div>
        </div>

        <div class="col-md-6 p-t-45 p-b-30">
          <div class="wrap-pic-welcome size2 bo-rad-10 hov-img-zoom m-l-r-auto">
            <img src="<?php echo base_url() ?>assets/images/data6.png" alt="IMG-OUR">
          </div>
        </div>
        ...
        <div class="col-md-6 p-t-45 p-b-30">
          <div class="section-intro mb-lg-4">
            ...
            <h2>
              Bantuan Sosial Covid Basah
            </h2>

            <p class="t-justify m-b-22 size3 m-l-r-auto">
            	Untuk melihat detail data penerima bantuan sosial covid basah silakan klik
            </p>
           <a class="button button-shadow mt-2 mt-lg-4" href="https://docs.google.com/spreadsheets/d/1RQ9v8rCvvGcCZTnnGP0P45ZlAQO1YP8ggM_SB0R_vgU/edit?usp=sharing">Disini</a>
          </div>
        </div>
        ...
        <div class="col-md-6 p-t-45 p-b-30">
          <div class="section-intro mb-lg-4">
            ...
            <p class="t-justify m-b-22 size3 m-l-r-auto">
              Untuk melihat detail data penerima bantuan sosial reguler silakan klik
            </p>
            <a class="button button-shadow mt-2 mt-lg-4" href="https://docs.google.com/spreadsheets/d/1WQCy42bO57UXTgWfcmeKvf1-iAO6zQpfyxSW8W1tRg8/edit?usp=sharing">Disini</a>
          </div>
        </div>
        ...
        <div class="col-md-6 p-t-45 p-b-30">
          <div class="wrap-pic-welcome size2 bo-rad-10 hov-img-zoom m-l-r-auto">
            <img src="<?php echo base_url() ?>assets/images/data7.png" alt="IMG-OUR">
          </div>
        </div>      
      </div>
      </div>
