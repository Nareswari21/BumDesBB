    ...
    <head>
        ...
        <meta charset="UTF-8">
        <!-- Site Title -->
        <title>Retribusi Persampahan</title>
                ...
                <div class="row d-flex justify-content-center">
                  <div class="menu-content pb-60 col-lg-8">
                    <div class="title text-center">
                      <h1 class="mb-10">Unit Retribusi Persampahan</h1>
                      <p>Berikut ini adalah menu dari unit retribusi persampahan</p>
                    </div>
                  </div>
                </div>          
                <div class="row">
                  <div class="col-lg-6">
                    <div class="single-price">
                      <div class="top-sec d-flex justify-content-between">
                        <div class="top-left">
                          <h4>Data</h4>
                          <p>Retribusi Persampahan</p>
                        </div>
                      </div>
                      <div class="bottom-sec">
                        <p>
                          Data Peserta Retribusi Persampahan
                        </p>
                      </div>
                      <div class="end-sec">
                        <ul>
                          <li>Data diri peserta iuran sampah dapat dilihat <a href="https://docs.google.com/spreadsheets/d/132cCRcrEp2QW2ZK-dvw9GWoimJWTH0p7DdHIk6-LP6s/edit?usp=sharing" class="txt4">Disini</a></li>
                        </ul>
                        <ul>
                          <li>Formulir data diri peserta baru dapat dimuat <a href="https://docs.google.com/spreadsheets/d/1WQCy42bO57UXTgWfcmeKvf1-iAO6zQpfyxSW8W1tRg8/edit?usp=sharing" class="txt4">
                          disini</a></li>
                        </ul>
                      </div>                
                    </div> 
                  ...
                  <div class="col-lg-6">
                    <div class="single-price">
                      <div class="top-sec d-flex justify-content-between">
                        <div class="top-left">
                          <h4>Data</h4>
                          <p>Data Pembayaran Retribusi Persampahan</p>
                        </div>
                      </div>
                      <div class="bottom-sec">
                        <p>
                          Data Pembayaran Retribusi Persampahan
                        </p>
                      </div>
                      <div class="end-sec">
                        <ul>
                          <li>Data pembayaran iuran sampah dilihat <a href="https://docs.google.com/spreadsheets/d/1q6IyY9VDmGo22SqYDgVyz4I4Gg1cRW9qqVQb2cwBts8/edit?usp=sharing" class="txt4">Disini</a></li>
                        </ul>
                        <ul>
                          <li>Formulir pembayaran iuran sampah dapat dimuat <a href="https://docs.google.com/spreadsheets/d/1WQCy42bO57UXTgWfcmeKvf1-iAO6zQpfyxSW8W1tRg8/edit?usp=sharing" class="txt4">
                          disini</a></li>
                        </ul>
                      </div>                
                    </div> 
