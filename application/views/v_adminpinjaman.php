                ...
                <div class="row d-flex justify-content-center">
                  <div class="menu-content pb-60 col-lg-8">
                    <div class="title text-center">
                      <h1 class="mb-10">Unit Simpan Pinjam</h1>
                      <p>Berikut ini adalah menu dari unit simpan pinjam</p>
                    </div>
                  </div>
                </div>          
                <div class="row">
                  <div class="col-lg-4">
                    <div class="single-price">
                      ...
                      <div class="end-sec">
                        <ul>
                          <li>Data Pencairan Dana berisi data masyarakat yang telah mengajukan pinjaman dan telah dicairkan. Data Pencairan Dana dapat dilihat <a href="https://docs.google.com/spreadsheets/d/1WQCy42bO57UXTgWfcmeKvf1-iAO6zQpfyxSW8W1tRg8/edit?usp=sharing" class="txt4"> Disini</a></li>
                        </ul>
                        <ul>
                          <li>Formulir pencairan dana dapat diisi <a href="https://forms.gle/y3BbbmU3AizQorYj7" class="txt4">
                          disini</a></li>
                        </ul>
                      </div>                
                    </div> 
                  ...
                  <div class="col-lg-4">
                    <div class="single-price">
                      ...
                      <div class="bottom-sec">
                        <p>
                          Data Penerimaan Angsuran Pinjaman
                        </p>
                      </div>
                      <div class="end-sec">
                        <ul>
                          <li>Data penerimaan angsuran adalah data masyarakat yang telah melakukan angsuran. Data ini dapat dilihat <a href="https://docs.google.com/spreadsheets/d/1aOxZLH6bn2-MiepZwjorfQnnxHmy0OKOr-Op-R5MohY/edit?usp=sharing" class="txt4">Disini</a></li>
                        </ul>
                        <ul>
                          <li>Formulir penerimaan angsuran dapat diisi <a href="https://forms.gle/fZcow9zzkWWhhwxs8" class="txt4">
                          disini</a></li>
                        </ul>
                  ...
                  <div class="col-lg-4">
                    <div class="single-price">
                      ...
                      <div class="end-sec">
                        <ul>
                          <li>Data debitur BUMDes Bangun Bersama Desa Kepunduhan adalah data hasil olahan dari Laporan Debitur yang diterima BUMDes Kepunduhan. Data Debitur BUMDes Kepunduhan dapat dilihat <a href="https://docs.google.com/spreadsheets/d/1RQ9v8rCvvGcCZTnnGP0P45ZlAQO1YP8ggM_SB0R_vgU/edit?usp=sharing" class="txt4">Disini</a></li>
                        </ul>
