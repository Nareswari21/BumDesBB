    ...
    <head>
        ...
        <meta charset="UTF-8">
        <!-- Site Title -->
        <title>Persewaan Alat Bangunan</title>
                ...
                <div class="row d-flex justify-content-center">
                  <div class="menu-content pb-60 col-lg-8">
                    <div class="title text-center">
                      <h1 class="mb-10">Unit Persewaan Alat Bangunan</h1>
                      <p>Berikut ini adalah menu dari unit persewaan alat bangunan</p>
                    </div>
                  </div>
                </div>          
                <div class="row">
                  <div class="col-lg-6">
                    <div class="single-price">
                      <div class="top-sec d-flex justify-content-between">
                        <div class="top-left">
                          <h4>Data</h4>
                          <p>Persewaan Alat Bangunan</p>
                        </div>
                      </div>
                      <div class="bottom-sec">
                        <p>
                          Data Persewaan Alat Bangunan
                        </p>
                      </div>
                      <div class="end-sec">
                        <ul>
                          <li>Data Persewaan Alat Bangunan dapat dilihat <a href="ttps://docs.google.com/spreadsheets/d/1ft1fytyxge7F7vDtCAvxlWL15CDL-b9EDOhlPuDHCVA/edit?usp=sharing" class="txt4">Disini</a></li>
                        </ul>
                        <ul>
                          <li>Formulir Persewaan Alat Bangunan dapat dimuat <a href="https://docs.google.com/spreadsheets/d/1WQCy42bO57UXTgWfcmeKvf1-iAO6zQpfyxSW8W1tRg8/edit?usp=sharing" class="txt4">
                          disini</a></li>
                        </ul>
                      </div>                
                    </div> 
                  ...
                  <div class="col-lg-6">
                    <div class="single-price">
                      <div class="top-sec d-flex justify-content-between">
                        <div class="top-left">
                          <h4>Data</h4>
                          <p>Data Pengembalian Persewaan Alat Bangunan</p>
                        </div>
                      </div>
                      <div class="bottom-sec">
                        <p>
                          Data Pengembalian Persewaan Alat Bangunan
                        </p>
                      </div>
                      <div class="end-sec">
                        <ul>
                          <li>Data Pengembalian Persewaan dapat dilihat <a href="https://docs.google.com/spreadsheets/d/1HCVkZgVks69tYPIvVkViiX1-k22NX7zn5TIPN4vm4vw/edit?usp=sharing" class="txt4">Disini</a></li>
                        </ul>
                        <ul>
                          <li>Formulir Pengembalian Persewaan dapat dimuat <a href="https://docs.google.com/spreadsheets/d/1WQCy42bO57UXTgWfcmeKvf1-iAO6zQpfyxSW8W1tRg8/edit?usp=sharing" class="txt4">
                          disini</a></li>
                        </ul>
                      </div>                
                    </div> 
