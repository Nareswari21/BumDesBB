                ...
                <div class="row d-flex justify-content-center">
                  <div class="menu-content pb-60 col-lg-8">
                    <div class="title text-center">
                      <h1 class="mb-10">Unit Payment Point Online Bank</h1>
                      <p>Berikut ini adalah menu dari unit Payment Point Online Bank</p>
                    </div>
                  </div>
                </div>          
                <div class="row">
                  <div class="col-lg-6">
                    <div class="single-price">
                      ...
                      <div class="bottom-sec">
                        <p>
                          Data Payment Point Online Bank
                        </p>
                      </div>
                      <div class="end-sec">
                        <ul>
                          <li>Data pengunjung yang melakukan transaksi payment point online bank dapat dilihat <a href="https://docs.google.com/spreadsheets/d/1RQ9v8rCvvGcCZTnnGP0P45ZlAQO1YP8ggM_SB0R_vgU/edit?usp=sharing" class="txt4">Disini</a></li>
                        </ul>
                      </div>                
                    </div> 
                  </div>
                  <div class="col-lg-6">
                    <div class="single-price">
                      ...
                      <div class="bottom-sec">
                        <p>
                          Formulir Transaksi Payment Point Online Bank
                        </p>
                      </div>
                      <div class="end-sec">
                        <ul>
                          <li>Formulir pengunjung yang akan melakukan transaksi payment point online bank dapat disini <a href="https://forms.gle/guLSkxubfmzFAPjt9" class="txt4">Disini</a></li>
                        </ul>
                      </div>                
                    </div> 
                  </div>                            
